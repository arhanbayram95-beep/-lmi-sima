...
const PRIVACY_POLICY_SECTIONS: LegalSection[] = [
  {
    heading: 'Overview',
    body:
      'This Privacy Policy applies to the Face Reader – AI Physiognomy Tool app ("Application"), offered on an "AS IS" basis. Face Reader provides a playful, entertainment-only AI character reading generated from photos you take in the app. This policy explains what we collect, how it is used, and the choices you have. Face Reader is intended for users aged 18 and over.',
  },
  {
  ...
  {
    heading: 'Face Data (User Photos)',
    body:
      "The Application allows you to capture one or more photos of your face so it can generate your entertainment reading — how many and of whom depends on which reading you choose: three of yourself for Character Analysis, one of yourself and one of another person for Relationship Harmony, or one of yourself for Career Match. These photos are used solely to generate descriptive, entertainment-style text about the vibe of each photo — nothing that identifies or verifies who anyone is. Face Reader does not perform facial recognition, does not create or store a faceprint, face template, or other biometric identifier, and does not match, compare, or look anyone up against a database of other people. Because of this, we do not treat these photos as biometric identifiers under laws like Illinois's Biometric Information Privacy Act (BIPA) or as \"biometric data\" under Article 9 of the GDPR, both of which are specifically about identification, not descriptive analysis. By capturing a photo in the app, you consent to its use for generating your reading. We never sell, lease, trade, or otherwise profit from these photos or any information derived from them.",
  },
  {
    heading: 'Third Party Access',
    body:
      "Only the minimum data each provider needs to do its job is shared, and only with the following third-party services, each of which has its own privacy policy governing how it handles data: Google's Gemini API (see Face Data & Third-Party Access below) and RevenueCat (subscription and purchase events). We may also disclose information as required by law, such as to comply with a subpoena or similar legal process; when we believe in good faith that disclosure is necessary to protect our rights or your safety, investigate fraud, or respond to a government request; or with trusted service providers who work on our behalf, have no independent use of the information, and are bound to the same rules set out in this policy. We do not sell your personal data to anyone.",
  },
  {
    heading: 'Face Data & Third-Party Access',
    body:
      "Photos captured for your reading are sent securely to our backend, which forwards them to our AI provider (currently Google's Gemini API) solely to generate your reading, along with a short instruction prompt — nothing else about you is sent. On Google's paid API tier, which Face Reader is intended to run on, Google does not use this content to train its models; a limited, short-lived log is kept solely to detect API abuse, per Google's own terms. Face data is not shared with any third party for advertising, marketing, or any other secondary use.",
  },
  {
  ...
  },
  {
    ...
    body:
      "We do not retain your photos after your reading is generated — they exist only for the seconds it takes to process a single request, both on our own servers and, per our agreement with our AI provider, on theirs. They are never written to disk, stored in a database, or kept between sessions. The generated reading text is kept only in your device's local history within the app until you clear it there; we do not store a history of past readings on our servers. Subscription and billing records are retained by RevenueCat per their standard retention practices. Support correspondence is kept only as long as needed to resolve your request — contact us at the email below if you'd like it deleted sooner.",
  },
  {
    heading: 'Your Rights',
    body:
      "If you are located in the EU/UK/EEA, you generally have the right to access, correct, delete, restrict, or port your personal data, to object to certain processing, and to lodge a complaint with your local data protection supervisory authority. If you are a California resident, you have rights under the CCPA/CPRA, including the right to know what categories of personal information we collect, the right to request deletion, and — because photos of your face could be considered sensitive personal information — the right to limit our use of it to what's needed to provide the reading you asked for, which is already the only use we make of it. We do not sell or 'share' (as CCPA defines that term, including for cross-context advertising) personal information. To exercise any of these rights, contact us using the details below.",
  },
  {
    heading: 'Children',
    body:
      "The Application does not knowingly solicit data from or market to anyone under the age of 18. Face Reader requires users to self-certify that they are 18 or older during onboarding. If we become aware that we have inadvertently processed data from someone under 18, we will delete it promptly — if you are a parent or guardian and believe your child has provided us with information, please contact us at the email below.",
  },
  {
    heading: 'Security',
    body:
...
const TERMS_SECTIONS: LegalSection[] = [
  {
    ...
    body:
      'These Terms & Conditions apply to the Face Reader – AI Physiognomy Tool app ("Application"), offered on an "AS IS" basis. By downloading, accessing, or using Face Reader, you agree to these Terms and our Privacy Policy. If you do not agree, please do not use the app.',
  },
  {
