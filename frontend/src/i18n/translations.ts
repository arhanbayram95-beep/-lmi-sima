...
export const translations = {
  ...
  'share.shareTextTemplate': {
    en: 'I just got "{badge}" on Face Reader ✨\n\n{summary}\n\n{details}Get your own AI face reading!{link}',
    zh: '我在 Face Reader 上获得了"{badge}" ✨\n\n{summary}\n\n{details}快来获取你自己的 AI 面部解读吧！{link}',
    hi: 'मुझे Face Reader पर "{badge}" मिला ✨\n\n{summary}\n\n{details}अपनी खुद की AI फेस रीडिंग पाएं!{link}',
    es: 'Acabo de obtener "{badge}" en Face Reader ✨\n\n{summary}\n\n{details}¡Consigue tu propia lectura facial con IA!{link}',
    fr: 'Je viens de recevoir "{badge}" sur Face Reader ✨\n\n{summary}\n\n{details}Obtenez votre propre lecture faciale par IA !{link}',
    ar: 'حصلت للتو على "{badge}" في Face Reader ✨\n\n{summary}\n\n{details}احصل على قراءة وجهك بالذكاء الاصطناعي!{link}',
    bn: 'আমি Face Reader-এ "{badge}" পেয়েছি ✨\n\n{summary}\n\n{details}আপনার নিজের AI ফেস রিডিং নিন!{link}',
    pt: 'Acabei de receber "{badge}" no Face Reader ✨\n\n{summary}\n\n{details}Obtenha a sua própria leitura facial com IA!{link}',
    ru: 'Я только что получил(а) "{badge}" в Face Reader ✨\n\n{summary}\n\n{details}Получите свой собственный ИИ-анализ лица!{link}',
    ur: 'مجھے Face Reader پر "{badge}" ملا ✨\n\n{summary}\n\n{details}اپنی AI فیس ریڈنگ حاصل کریں!{link}',
  },
  'welcome.headline': {
