...
export const translations = {
  ...
  'onboarding.step0.headline': {
    ...
    ar: 'قراءة تعابير عصرية', bn: 'আধুনিক এক্সপ্রেশন রিডিং', pt: 'Leitura de expressões moderna',
    ru: 'Современный анализ выражений лица', ur: 'جدید ایکسپریشن ریڈنگ',
  },
  ...
  'paywall.headline': {
    en: 'Unlock Full Face Insights', zh: '解锁完整面部洞察', hi: 'पूर्ण फेस इनसाइट्स अनलॉक करें',
    es: 'Desbloquea todos los análisis faciales', fr: 'Débloquez toutes les analyses faciales',
    ar: 'افتح رؤى الوجه الكاملة', bn: 'সম্পূর্ণ ফেস ইনসাইট আনলক করুন', pt: 'Desbloqueie todas as análises faciais',
    ru: 'Откройте полный анализ лица', ur: 'مکمل فیس بصیرت اَن لاک کریں',
  },
  'paywall.subtitle': {
    en: 'Experience unlimited face readings and deep personality reports, unlocked instantly.',
    zh: '体验无限次面部解读与深度性格报告，即刻解锁。',
    hi: 'असीमित फेस रीडिंग और गहन व्यक्तित्व रिपोर्ट का अनुभव करें, तुरंत अनलॉक।',
    es: 'Disfruta de lecturas faciales ilimitadas e informes de personalidad profundos, desbloqueados al instante.',
    fr: "Profitez de lectures faciales illimitées et de rapports de personnalité approfondis, débloqués instantanément.",
    ar: 'استمتع بقراءات وجه غير محدودة وتقارير شخصية عميقة، تُفتح فورًا.',
    bn: 'সীমাহীন ফেস রিডিং ও গভীর ব্যক্তিত্ব রিপোর্ট উপভোগ করুন, তাৎক্ষণিকভাবে আনলক।',
    pt: 'Desfrute de leituras faciais ilimitadas e relatórios de personalidade profundos, desbloqueados instantaneamente.',
    ru: 'Получите неограниченные анализы лица и глубокие отчёты о личности — разблокировано мгновенно.',
    ur: 'لامحدود فیس ریڈنگز اور گہری شخصیت رپورٹس سے لطف اندوز ہوں، فوری اَن لاک۔',
  },
  ...
  'paywall.feature1': {
    en: 'Unlimited Readings — Character, Relationship & Career', zh: '无限次解读——性格、关系与职业',
    hi: 'असीमित रीडिंग — कैरेक्टर, रिलेशनशिप और करियर', es: 'Lecturas ilimitadas: carácter, relación y carrera',
    fr: 'Lectures illimitées : caractère, relation et carrière', ar: 'قراءات غير محدودة — الشخصية والعلاقة والمسار المهني',
    bn: 'সীমাহীন রিডিং — ক্যারেক্টার, রিলেশনশিপ ও ক্যারিয়ার', pt: 'Leituras ilimitadas: caráter, relacionamento e carreira',
    ru: 'Неограниченные анализы — характер, отношения и карьера', ur: 'لامحدود ریڈنگز — کریکٹر، ریلیشن شپ اور کیریئر',
  },
  'paywall.feature2': {
  ...
  'analyzing.subtitle': {
    en: 'Your reading is taking shape...', zh: '你的解读正在成形……',
    hi: 'आपकी रीडिंग आकार ले रही है...', es: 'Tu lectura está tomando forma...',
    fr: 'Votre lecture prend forme...', ar: 'قراءتك تتشكل الآن...',
    bn: 'আপনার রিডিং আকার নিচ্ছে...', pt: 'A sua leitura está a tomar forma...',
    ru: 'Ваш анализ обретает форму...', ur: 'آپ کی ریڈنگ تشکیل پا رہی ہے...',
  },
  ...
  'share.shareTextTemplate': {
    en: 'I just got "{badge}" on Face Reader ✨\n\n{summary}\n\n{details}Get your own face reading!{link}',
    zh: '我在 Face Reader 上获得了"{badge}" ✨\n\n{summary}\n\n{details}快来获取你自己的面部解读吧！{link}',
    hi: 'मुझे Face Reader पर "{badge}" मिला ✨\n\n{summary}\n\n{details}अपनी खुद की फेस रीडिंग पाएं!{link}',
    es: 'Acabo de obtener "{badge}" en Face Reader ✨\n\n{summary}\n\n{details}¡Consigue tu propia lectura facial!{link}',
    fr: 'Je viens de recevoir "{badge}" sur Face Reader ✨\n\n{summary}\n\n{details}Obtenez votre propre lecture faciale !{link}',
    ar: 'حصلت للتو على "{badge}" في Face Reader ✨\n\n{summary}\n\n{details}احصل على قراءة وجهك الخاصة!{link}',
    bn: 'আমি Face Reader-এ "{badge}" পেয়েছি ✨\n\n{summary}\n\n{details}আপনার নিজের ফেস রিডিং নিন!{link}',
    pt: 'Acabei de receber "{badge}" no Face Reader ✨\n\n{summary}\n\n{details}Obtenha a sua própria leitura facial!{link}',
    ru: 'Я только что получил(а) "{badge}" в Face Reader ✨\n\n{summary}\n\n{details}Получите свой собственный анализ лица!{link}',
    ur: 'مجھے Face Reader پر "{badge}" ملا ✨\n\n{summary}\n\n{details}اپنی فیس ریڈنگ حاصل کریں!{link}',
  },
  'welcome.headline': {
  ...
  'welcome.subtitle': {
    en: "Your character reading journey starts now. Capture your first photos whenever you're ready.",
    zh: '你的性格解读之旅现在开始。准备好后即可拍摄你的照片。',
    hi: 'आपकी कैरेक्टर रीडिंग यात्रा अभी शुरू होती है। जब भी तैयार हों, अपनी फ़ोटो कैप्चर करें।',
    es: 'Tu viaje de lectura de carácter comienza ahora. Captura tus fotos cuando quieras.',
    fr: 'Votre parcours de lecture de caractère commence maintenant. Capturez vos photos quand vous serez prêt.',
    ar: 'تبدأ رحلتك في قراءة الشخصية الآن. التقط صورك عندما تكون مستعدًا.',
    bn: 'আপনার ক্যারেক্টার রিডিং যাত্রা এখনই শুরু হচ্ছে। প্রস্তুত হলে আপনার ছবি ধারণ করুন।',
    pt: 'A sua jornada de leitura de caráter começa agora. Capture as suas fotos quando estiver pronto.',
    ru: 'Ваше путешествие в анализ характера начинается прямо сейчас. Сделайте фото, когда будете готовы.',
    ur: 'آپ کا کریکٹر ریڈنگ سفر ابھی شروع ہوتا ہے۔ جب تیار ہوں اپنی تصاویر کیپچر کریں۔',
  },
  'welcome.cta': {
