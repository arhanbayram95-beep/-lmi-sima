// Original drafts tailored to Face Reader's actual architecture (see PROJECT_SPEC.md
...
// checked by counsel against the jurisdictions Face Reader actually launches in.
//
...
export const PRIVACY_POLICY_SECTIONS: LegalSection[] = [
  {
    heading: 'Overview',
    body:
      'Face Reader ("we", "us") provides a playful, entertainment-only AI character and expression reading generated from three photos you take in the app. This policy explains what we collect, how your photos are used, and what choices you have. Face Reader is intended for users aged 18 and over.',
  },
  {
